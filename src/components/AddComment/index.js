    ...
    handleSubmit(event) {  // handles form submit without any jquery
        ...
        */
        ...
        if( !data.name || !data.message){
            ...
            document.getElementById('message_status').innerHTML = '<div id="thankyou_message" class="uk-alert-success" uk-alert=""><p>Comment Added! Thank you!</p></div>';
            document.getElementById("name").classList.remove("uk-form-success");
            document.getElementById("message").classList.remove("uk-form-success");
            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <fieldset className="uk-fieldset">
                        <p className='uk-align-left'>If your question is more personal head over to <Link to="/contact">contact</Link></p>
